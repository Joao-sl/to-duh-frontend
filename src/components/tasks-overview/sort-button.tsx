...
import { SortDirection, SortField } from './sort-tasks';
import { SortState } from './use-tasks-overview';
        ...
        <div className='space-y-2'>
          <div className='flex flex-col gap-0.5'>
            ...
            <Button
              size='default'
              variant='ghost'
              onClick={() => (onSort('dueAt', sort.direction), setOpen(false))}
              className={cn('justify-start', {
                'bg-accent/80': sort.field === 'dueAt',
              })}
            >
              Due
            </Button>
            ...
            <Button
              ...
              variant='ghost'
              onClick={() => (
                onSort('completedAt', sort.direction),
                setOpen(false)
              )}
              className={cn('justify-start', {
                'bg-accent/80': sort.field === 'completedAt',
              })}
            >
              Completed
            </Button>
